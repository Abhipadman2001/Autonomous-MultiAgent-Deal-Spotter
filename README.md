...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/Abhipadman2001/Autonomous-MultiAgent-Deal-Spotter.git](https://github.com/Abhipadman2001/Autonomous-MultiAgent-Deal-Spotter.git)
   cd Autonomous-MultiAgent-Deal-Spotter
